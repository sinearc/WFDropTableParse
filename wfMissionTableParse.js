...
function MissionTableParse (id) {
    let missionTable = Array.from(document.getElementById(id).nextElementSibling.children[0].children)
    ...
    console.log(individualTablesNumber)
    console.log(missionTablePairedChances)
